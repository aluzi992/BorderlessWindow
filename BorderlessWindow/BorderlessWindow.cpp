// BorderlessWindow.cpp : 定义应用程序的入口点。
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = L"";// MAKEINTRESOURCEW(IDC_BORDERLESSWINDOW);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_POPUP | WSF_VISIBLE | WS_MAXIMIZEBOX | WS_MINIMIZEBOX | WS_THICKFRAME|WS_CLIPSIBLINGS|WS_CLIPCHILDREN,
   ...
   SetWindowLongW(hWnd, GWL_EXSTYLE, WS_OVERLAPPEDWINDOW | WS_EX_LAYERED);
   UpdateWindow(hWnd);
